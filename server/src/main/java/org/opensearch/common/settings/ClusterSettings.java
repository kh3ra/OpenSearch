    ...
    public static Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Collections.unmodifiableSet(
        new HashSet<>(
            Arrays.asList(
                ...
                RecoverySettings.INDICES_REPLICATION_MERGED_SEGMENT_WARMER_SEGMENT_SIZE_THRESHOLD_SETTING,
                RecoverySettings.INDICES_REPLICATION_MERGED_SEGMENT_WARMER_ENABLED_SETTING,
                RecoverySettings.INDICES_REPLICATION_MERGED_SEGMENT_WARMER_MAX_BYTES_PER_SEC_SETTING,
                RecoverySettings.INDICES_REPLICATION_MERGED_SEGMENT_WARMER_TIMEOUT_SETTING,
                RecoverySettings.INDICES_INDEXING_THROTTLE_INFLIGHT_MERGES_THRESHOLD_SETTING,
                ...
                MergeSchedulerConfig.CLUSTER_DEFAULT_MAX_THREAD_COUNT_SETTING,
                MergeSchedulerConfig.CLUSTER_DEFAULT_MAX_MERGE_COUNT_SETTING,
